...
const HandiCraftItem = ({ item }) => {
  return (
    <div className="bg-orange-200  flex flex-col rounded-md p-2 space-y-2">
      ...
      <div className="pt-2 pb-1">
        <button className="w-full btn border-0 outline-0 text-slate-200  bg-slate-700 hover:bg-orange-400 hover:text-slate-200">
          select for BIDding
        </button>
      </div>
    </div>
