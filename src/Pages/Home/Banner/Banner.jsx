...
const Banner = () => {
  return (
    ...
    >
      <div>
        <img style={{ height: "600px" }} src={banner1} alt="" />
      ...
      <div>
        <img style={{ height: "600px" }} src={banner2} alt="" />
        <div className="absolute z-10 top-72 bg-slate-800 bg-opacity-40  w-2/3  space-y-5 py-5  ml-28">
          <h2 className="text-lime-200 font-semibold text-5xl">
            Crafted With Heart and Hands
          </h2>
          <p className="text-slate-200 text-xl font-semibold">
            Beyond the pixels and pixels, there's artistry that's felt. Explore
            a selection of crafts that reflect the dedication and expertise of
            artisans. With each piece, you're not just acquiring an object –
            you're embracing a piece of their craft and soul.
          </p>
          <button className="btn bg-lime-600 hover:text-slate-800 text-slate-200 border-lime-600">
            Discover
          </button>
      ...
      <div>
        <img style={{ height: "600px" }} src={banner3} alt="" />
        <div className="absolute z-10 top-72 bg-slate-800 bg-opacity-40  w-2/3  space-y-5 py-5  ml-28">
      ...
      <div>
        <img style={{ height: "600px" }} src={banner4} alt="" />
        <div className="absolute z-10 top-72 bg-slate-800 bg-opacity-40  w-2/3  space-y-5 py-5  ml-28">
          <h2 className="text-lime-400 font-semibold text-5xl">
          ...
          <p className="text-slate-200 text-xl font-semibold">
            ...
            artistic marvels. Immerse yourself in a diverse tapestry of art and
            crafts that push the limits of imagination and craftsmanship,
      ...
      <div>
        <img style={{ height: "600px" }} src={banner5} alt="" />
        <div className="absolute z-10 top-72 bg-slate-800 bg-opacity-40  w-2/3  space-y-5 py-5  ml-28">
          <h2 className="text-lime-200 font-semibold text-5xl">
            Elevate Your Space with Artistry
          </h2>
          <p className="text-slate-200 text-xl font-semibold">
            Transform your living spaces with the beauty of handcrafted art and
            crafts. From captivating paintings to intricate sculptures, our
            platform connects you with remarkable pieces that add a touch of
            elegance and uniqueness to your surroundings.
          </p>
          <button className="btn bg-lime-600 hover:text-slate-800 text-slate-200 border-lime-600">
            Discover
          </button>
